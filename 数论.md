当且仅当 p 为质数时![image-20230218152839233](C:\Users\666\AppData\Roaming\Typora\typora-user-images\image-20230218152839233.png)在n , m很大而 p 又很小的时候就可以使用 Lucas定理。p一般不大于1e5。
